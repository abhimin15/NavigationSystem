...
public class MainActivity extends AppCompatActivity {
    ...
    private List<node> findPath(String s, String d) {
        ...
        node nodeA = new node("Back door",40,865);
        node nodeB = new node("UG LAB gate",300,865);
        node nodeC = new node("Wash Room 1",300,678);
        node nodeD = new node("HOD Room",300,330);
        node nodeE = new node("Junction 1",300,183);
        node nodeF = new node("Entrance",40,183);
        node nodeG = new node("Wash room 2",300,83);
